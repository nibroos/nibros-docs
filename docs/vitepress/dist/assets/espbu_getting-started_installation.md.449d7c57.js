import{_ as s,o as a,c as n,Q as l}from"./chunks/framework.61f21335.js";const u=JSON.parse('{"title":"Installation","description":"","frontmatter":{},"headers":[],"relativePath":"espbu/getting-started/installation.md","filePath":"espbu/getting-started/installation.md"}'),p={name:"espbu/getting-started/installation.md"},e=l(`<h1 id="installation" tabindex="-1">Installation <a class="header-anchor" href="#installation" aria-label="Permalink to &quot;Installation&quot;">​</a></h1><h2 id="prerequisites" tabindex="-1">Prerequisites <a class="header-anchor" href="#prerequisites" aria-label="Permalink to &quot;Prerequisites&quot;">​</a></h2><ul><li>PHP 8.0.2 or higher</li><li>Node.js 16 or above</li><li>MySQL 8.0.2</li><li>wkhtmltopdf, if export PDF is needed. Take a look at <a href="https://github.com/barryvdh/laravel-snappy" target="_blank" rel="noreferrer">Laravel Snappy Docs</a></li></ul><h2 id="setup" tabindex="-1">Setup <a class="header-anchor" href="#setup" aria-label="Permalink to &quot;Setup&quot;">​</a></h2><ol><li>Setup environment. copy the .env.example then change the name to .env and some of the value of it based on your environment <br></li></ol><div class="language-json vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">json</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">APP_NAME=</span><span style="color:#9ECBFF;">&quot;E-SPBU&quot;</span></span>
